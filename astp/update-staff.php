...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT staff.*, astp.branch FROM staff 
              JOIN astp ON staff.astp_id = astp.astp_id
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE staff SET name=?, position=?, dob=?, no_ic=?, no_phone=?, bank_name=?, bank_account=?, email=?, image=? WHERE staff_id=?";
    $stmt = mysqli_prepare($conn, $query);
    mysqli_stmt_bind_param($stmt, 'ssssssssss', $name, $position, $dob, $no_ic, $phone_num, $bank_name, $bank_account, $email, $image, $id);
...
<body>
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <form action="update-staff.php?id=<?php echo htmlspecialchars($id); ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['staff_id']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_phone" class="form-control" value="<?php echo htmlspecialchars($row['no_phone']); ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <a href="astp_view_staff.php" class="btn btn-danger">Kembali</a>
    ...
    <?php if ($update_success): ?>
        <script>
            ...
            window.location.href = "display-staff.php?id=<?php echo htmlspecialchars($row['staff_id']); ?>"
        </script>
    <?php endif; ?>
</body>
</html>
