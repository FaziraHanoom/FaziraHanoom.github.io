                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-7">
                        <div class="info-container">
                            <p><strong>No Anggota</strong> <?php echo htmlspecialchars($row['staff_id']); ?></p>
                            ...
                            <p><strong>No. Telefon</strong> <?php echo htmlspecialchars($row['no_phone']); ?></p>
                    ...
                    <img src="../images/<?php echo htmlspecialchars($row['image']); ?>" class="mt-3" style="max-width: 300px; max: height 400px;" alt="Profile Image">
                    </div>
                </div>
                <div class="back-button-container">
                    <a href="astp_view_staff.php" class="btn btn-danger">Kembali</a>
                    <a href="update-staff.php?id=<?php echo htmlspecialchars($row['staff_id']); ?>" class="btn btn-primary">Kemaskini</a>
            </div>
        </div>
    </div>
</body>
